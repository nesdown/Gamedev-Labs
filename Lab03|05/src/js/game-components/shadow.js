const bright = [0xaa3333, 0x3333aa, 0xaaaa33, 0x33aa33];
const dim = [0xdd3333, 0x3333dd, 0xdddd33, 0x33dd33];
/**
 * Shadow below snake
 ...
 */
const Shadow = function(game, sections, scale, tint) {
    this.game = game;
    ...
    this.lightTintBright = bright[tint];
    this.lightTintDim = dim[tint];
}
